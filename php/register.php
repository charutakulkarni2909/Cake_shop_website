...
<body>
		<nav class="navbar navbar-expand-lg navbar-dark bg-warning ">
		  	<div class="container-fluid">
			    ...
			    <a class="navbar-brand"style ="font-size: 150%" href = "#"><h3>Register</h3></a>
			    ...
			    <div class="collapse navbar-collapse" id="navbarNavDropdown">
			      <ul class="navbar-nav" style="margin-left: 75% ;font-size: 100%;">
			        <li class="nav-item">
			          <a class="nav-link active " href="login.php"><h4>Login to Eats & Treats</h4></a>
			        </li>
			      </ul>
			    </div>
		  	</div>
		...
		<div class = "center">
            <form action="confirmpassword.php" method="post">
                <h2>A Bite of Deliciousness is just one click away from you !</h2><br>
			    <h6></h6>
                <div class="row">
                    <div class="col lg-6">
