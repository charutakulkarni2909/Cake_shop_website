...
if($result){
	...
	while($row=mysqli_fetch_assoc($result))
		{	
			...
			echo "<li><a href= '#'><img src='./image/$row[file_name]' width='400px' height='200px'>";

			echo "$row[name]&nbsp$row[price]</a>";
			echo str_repeat("&nbsp;", 5); 
			echo "<a href ='delete.php?id=$row[id]' onclick = myFunction1()>Delete</a></li>";
